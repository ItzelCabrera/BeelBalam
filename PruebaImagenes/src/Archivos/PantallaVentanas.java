...
public class PantallaVentanas extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        cbHorario.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "09:00:00", "13:00:00", "17:00:00" }));
    ...
    private void btnComprarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnComprarActionPerformed
       if(txtNombres.getText().isEmpty()||txtApeP.getText().isEmpty()||txtEdad.getText().isEmpty()||
            ...
            StringTokenizer hr = new StringTokenizer(cbHorario.getSelectedItem().toString(),":");
            ...
            String placa ="";
            if(cbDir.getSelectedIndex() == 0){
                placa=cbTramo.getSelectedItem().toString().concat("I");
            }else if(cbDir.getSelectedIndex() == 1){
            ...
            reserva.setDateR(date.concat(" ").concat(cbHorario.getSelectedItem().toString()));
    ...
    public String editUsuario(String u,int cvc,int fecha,String pN,JComboBox jcb,String sN,String pA,String sA){
        ...
        String r = null;
        try (Connection conex = DriverManager.getConnection("jdbc:sqlserver://LAPTOP-3A3Q5S9M\\SQLEXPRESS:1433;databaseName=BEEL_BALAM", "sa", "ABCpiz12")) {
